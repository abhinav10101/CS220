...
`define READ_COMMAND 2'b01 // 2-bit updated Memory read command
`define WRITE_COMMAND 2'b10 // 2-bit updated Memory write command
`define SUBWORD_WRITE_COMMAND 2'b11
